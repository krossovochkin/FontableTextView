...
public class FontableAutocompleteTextView extends AutoCompleteTextView {
    ...
    public FontableAutocompleteTextView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.FontableAutocompleteTextView);

        if(a != null) {
            int typefaceId = a.getInt(R.styleable.FontableAutocompleteTextView_typeface, 0);
