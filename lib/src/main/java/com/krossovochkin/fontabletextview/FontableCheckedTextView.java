...
public class FontableCheckedTextView extends CheckedTextView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.FontableCheckedTextView);

        if(a != null) {
            int typefaceId = a.getInt(R.styleable.FontableCheckedTextView_typeface, 0);
